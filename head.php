...
?>	
	...
	<meta property="og:url" content="http://www.minivertising-test.com/video_detail.php?idx=<?=$video_idx?>" />
	<meta property="og:image" content="<?=$yt_thumb?>" />
	<meta property="og:description" content="<?=$detail_data["video_title"]?>">
<?
	}else{
?>	
	<meta property="og:type" content="website" />
	...
	<meta property="og:image" content="http://www.minivertising-test.com/images/main_image.png" />
