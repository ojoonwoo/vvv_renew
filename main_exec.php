	...
	switch ($_REQUEST['exec'])
	{
		...
		case "member_kakao_login" :
            ...
            if ($login_data['idx'])
			{
				...
				$query    = "INSERT INTO member_info(mb_login_way, mb_name, mb_email, mb_media, mb_kakao_email_verified, mb_kakao_way_id, mb_kakao_profile_img, mb_kakao_thumbnail_img, mb_join_date, mb_login_date, mb_join_ipaddr) values('".$mb_login_way."','".$mb_kakao_name."','".$mb_email."','".$_SESSION['ss_media']."','".$mb_kakao_email_verified."','".$mb_kakao_way_id."','".$mb_kakao_profile_img."','".$mb_kakao_thumbnail_img."','".date("Y-m-d H:i:s")."','".date("Y-m-d H:i:s")."','".$_SERVER['REMOTE_ADDR']."')";
				$result   = mysqli_query($my_db, $query);
		...
		case "member_facebook_login" :
			...
			if ($login_data['idx'])
			{
				...
				$query    = "INSERT INTO member_info(mb_login_way, mb_name, mb_email, mb_media, mb_facebook_gender, mb_facebook_birthday, mb_facebook_way_id   , mb_join_date, mb_login_date, mb_join_ipaddr) values('".$mb_login_way."','".$mb_facebook_name."','".$mb_email."','".$_SESSION['ss_media']."','".$mb_facebook_gender."','".$mb_facebook_birthday."','".$mb_facebook_way_id."','".date("Y-m-d H:i:s")."','".date("Y-m-d H:i:s")."','".$_SERVER['REMOTE_ADDR']."')";
				$result   = mysqli_query($my_db, $query);
                $uid      = mysqli_insert_id($my_db);
